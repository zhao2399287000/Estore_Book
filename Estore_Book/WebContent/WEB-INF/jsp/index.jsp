				...
				<div class="tuijian_product" style="min-width: 750px;">
					<c:forEach items="${productsList }" var="pro">
						<div style="float: left; margin: 10px 30px;">
							...
							</a> <br> <span>价格: ￥${pro.price }</span> <br> <a href="${pageContext.request.contextPath }/showProductInfo?id=${pro.id}">查看详细</a>
							<br>
							<button
								style="background: #87520E; color: white; line-height: 15px; font-size: 13px; border-radius: 5px; border: #87520E; cursor: pointer;"
								onclick="addCar('${pro.id}')">加入购物车</button>
						</div>
					</c:forEach>
				</div>
				<div style="float: none; margin-top: 20px;">
					<a
						href="${pageContext.request.contextPath }/showIndex?page=${pagebean.page - 1}"><button
							type="button" id="up"
